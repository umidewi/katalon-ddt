...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'), '30/05/1990')

WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_Comment_comment'), 'Hongkong Comment')
...
WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/p_No'), 'No')

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_None'), 'None')

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_30051990'), '30/05/1990')

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Hongkong Comment'), 'Hongkong Comment')
