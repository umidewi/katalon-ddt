...
WebUI.click(findTestObject('Page_CURA Healthcare Service/input_None_programs', [('program') : program]))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_None'), ver_program)

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_30051990'), ver_date)

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Hongkong Comment'), ver_comment)
