...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Comment for Seoul CURA')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_30052024'), '30/05/2024')

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/p_Comment for Seoul CURA'), 'Comment for Seoul CURA')
